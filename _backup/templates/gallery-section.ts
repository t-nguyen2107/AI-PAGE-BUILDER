...
export function generateGallerySection(props?: Record<string, unknown>): SectionNode {
  ...
  const galleryComponents: ComponentNode[] = images.map((image) => {
    ...
    if (image.caption) {
      children.push({
        ...
        typography: { fontSize: '0.875rem', color: 'var(--muted-foreground)', textAlign: TextAlign.CENTER },
        meta: { createdAt: now, updatedAt: now },
      });
    }
  ...
  // Container 1: heading with subtitle
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            content: 'A showcase of our finest work and creative projects',
