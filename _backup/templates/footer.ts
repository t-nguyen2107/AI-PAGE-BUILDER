...
export function generateFooter(props?: Record<string, unknown>): SectionNode {
    ...
    children: [
      {
        ...
        content: siteName,
        typography: { fontSize: '1.25rem', fontWeight: '700', color: 'var(--inverse-on-surface)' },
        meta: { createdAt: now, updatedAt: now },
      },
      {
        id: brandDescId,
        ...
        typography: { fontSize: '0.875rem', color: 'rgba(255,255,255,0.6)' },
        meta: { createdAt: now, updatedAt: now },
      },
    ],
  };
      ...
      children: [
        {
          ...
          content: col.title,
          typography: { fontSize: '0.875rem', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.05em', color: 'var(--inverse-on-surface)' },
          meta: { createdAt: now, updatedAt: now },
        },
        {
          id: colListId,
  ...
  return {
    ...
    className: 'footer-section pb-section-dark',
    ...
    children: [
      ...
      },
      {
        ...
        inlineStyles: { borderTop: '1px solid rgba(255,255,255,0.1)', maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' },
        meta: { createdAt: now, updatedAt: now },
        children: [],
        layout: {},
      },
            ...
            children: [
              {
                ...
                content: copyright,
                typography: { fontSize: '0.8125rem', color: 'rgba(255,255,255,0.5)' },
                meta: { createdAt: now, updatedAt: now },
              },
            ],
          },
