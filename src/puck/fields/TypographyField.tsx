        ...
        {(["left", "center", "right", "justify"] as const).map((a) => (
          <button
            ...
            className={`flex-1 flex items-center justify-center py-1.5 rounded border ${
              v.textAlign === a ? "border-indigo-400 bg-indigo-50 text-indigo-600" : "border-gray-200 text-gray-500"
            }`}
          >
      ...
      <div className="flex gap-1">
        <button
          ...
          className={`flex-1 flex items-center justify-center py-1 rounded border text-xs ${
            v.fontStyle === "italic" ? "border-indigo-400 bg-indigo-50 text-indigo-600" : "border-gray-200 text-gray-500"
          }`}
        >
        ...
        <button
          ...
          className={`flex-1 flex items-center justify-center py-1 rounded border text-xs ${
            v.textDecoration === "underline" ? "border-indigo-400 bg-indigo-50 text-indigo-600" : "border-gray-200 text-gray-500"
          }`}
        >
        ...
        <button
          ...
          className={`flex-1 flex items-center justify-center py-1 rounded border text-xs ${
            v.textTransform === "uppercase" ? "border-indigo-400 bg-indigo-50 text-indigo-600" : "border-gray-200 text-gray-500"
          }`}
        >
